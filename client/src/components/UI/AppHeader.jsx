                    ...
                    <ul className="nav navbar-nav navbar-right">
                        ...
                        <li className="dropdown">
                            <a
                                ...
                                className="dropdown-toggle waves-effect waves-button waves-classic"
                                data-toggle="dropdown">
                                <span className="user-name">David<i className="fa fa-angle-down"></i>
                                </span>
                                <img
                            ...
                            <ul className="dropdown-menu dropdown-list" role="menu">
                                <li role="presentation">
                                    <a href="javascript:void(0)" onClick={onClickProfile}>
                                ...
                                <li role="presentation">
                                    <a href="/logout">
                                        <i className="fa fa-sign-out m-r-xs"></i>Log out</a>
                                </li>
                            </ul>
                        </li>
                        <li>
